...
export const mockBookings: BookingWithCourt[] = [{ id: 'booking-1', courtId: 'court-1', userId: 'u-customer', startTime: iso(2, 18), endTime: iso(2, 20), status: 'CONFIRMED', createdAt: now.toISOString(), court: mockCourts[0] }]
