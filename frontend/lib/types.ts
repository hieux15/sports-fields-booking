...
export type Court = { id: string; name: string; type: CourtTypeKey; address: string | null; imageUrl: string | null; pricePerHour: string; openTime: string; closeTime: string; ownerId: string; avgRating: number | null; reviews: Review[] }
...
export type Review = { id: string; userId: string; courtId: string; rating: number; comment: string | null; userName: string; createdAt: string }
...
export type CourtSort = 'name_asc' | 'name_desc' | 'price_asc' | 'price_desc' | 'rating_desc'
