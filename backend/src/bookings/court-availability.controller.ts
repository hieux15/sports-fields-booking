...
export class CourtAvailabilityController {
  ...
  @Get(':id/availability')
  @ApiOperation({ summary: 'Các khung giờ còn trống của sân theo ngày và thời lượng' })
  ...
  @ApiOkResponse({ description: 'Ngày, thời lượng và các khung giờ có thể đặt' })
  getAvailability(@Param('id') id: string, @Query() query: CourtAvailabilityDto) {
